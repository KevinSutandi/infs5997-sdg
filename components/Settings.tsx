...
export function Settings({ trigger }: SettingsProps) {
  ...
  const [editStudentId] = useState('S2024001234');
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1 space-y-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1">S2024001234</p>
                    </div>
                    <div>
                      <Label className="text-xs text-muted-foreground">Faculty</Label>
                      <p className="mt-1">{currentUser.faculty}</p>
                    </div>
                  </div>
            ...
            <section>
              ...
              <Card className="divide-y">
                ...
                <div className="p-5 hover:bg-muted/50 transition-colors">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      <Label className="mb-1 block">Analytics & Performance</Label>
                      <p className="text-sm text-muted-foreground">
                ...
                <div className="p-5 hover:bg-muted/50 transition-colors">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      <Label className="mb-1 block">Personalization</Label>
                      <p className="text-sm text-muted-foreground">
            ...
            <section>
              ...
              <Card className="divide-y">
                ...
                <div className="p-5 hover:bg-muted/50 transition-colors">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      <Label className="mb-1 block">Activity Reminders</Label>
                      <p className="text-sm text-muted-foreground">
                ...
                <div className="p-5 hover:bg-muted/50 transition-colors">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      <Label className="mb-1 block">Achievement Alerts</Label>
                      <p className="text-sm text-muted-foreground">
                ...
                <div className="p-5 hover:bg-muted/50 transition-colors">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      <Label className="mb-1 block">Weekly Digest</Label>
                      <p className="text-sm text-muted-foreground">
